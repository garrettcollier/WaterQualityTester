        ...
        child: Column(
          children: <Widget>[
            ...
            TextButton(onPressed: () {showDialog(
                      ...
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          ...
                          content: Text("EPA Standard Recommended Limit: 0 mg/L. \nCauses rotten egg odor and foul taste"),
                        );
                      });}, child: Text("Hydrogen Sulfide")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Iron"),
                          content: Text("EPA Standard Recommended Limit: 0.3 mg/L \nCauses rusty color and staining, metallic taste"),
                        );
                      });}, child: Text("Iron")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Copper"),
                          content: Text("EPA Standard Recommended Limit: 1.3 mg/L. \nCauses liver and kidney damage"),
                        );
                      });}, child: Text("Copper")),
            TextButton(onPressed: () {showDialog(
                      context: context,
            ...
            TextButton(onPressed: () {showDialog(
                      ...
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          ...
                          content: Text("EPA Standard Recommended Limit: 0.05 mg/L. \nCauses black/brown color, bitter metallic taste"),
                        );
                      });}, child: Text("Manganese")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Total Chlorine"),
                          content: Text("EPA Standard Recommended Limit: 4 mg/L. \nCauses skin irritation and stomach discomfort"),
                        );
                      });}, child: Text("Total Chlorine")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Free Chlorine"),
                          content: Text("EPA Standard Recommended Limit: . \nCauses "),
                        );
                      });}, child: Text("Free Chlorine")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Nitrate"),
                          content: Text("EPA Standard Recommended Limit: 10 mg/L. \nCauses Blue Baby syndrome in infants under 6 months, shortness of breath, nausea, and dizziness"),
                        );
                      });}, child: Text("Nitrate")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Nitrite"),
                          content: Text("EPA Standard Recommended Limit: 1 mg/L. \nCauses Blue Baby Syndrome in infants under 6 months, shortness of breath, nausea, and dizziness"),
                        );
                      });}, child: Text("Nitrite")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Sulfate"),
                          content: Text("EPA Standard Recommended Limit: 250 mg/L. \nCauses salty taste"),
                        );
                      });}, child: Text("Sulfate")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Zinc"),
                          content: Text("EPA Standard Recommended Limit: 5 mg/L. \nCauses metallic taste"),
                        );
                      });}, child: Text("Zinc")),
            TextButton(onPressed: () {showDialog(
                      context: context,
            ...
            TextButton(onPressed: () {showDialog(
                      ...
                      });}, child: Text("Sodium Chloride")),
            TextButton(onPressed: () {showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return const AlertDialog(
                          title: Text("Total Alkalinity"),
                          content: Text("EPA Standard Recommended Limit: 75-150 mg/L. \nLow alkalinity associated with acidic pH and corrosion"),
                        );
                      });}, child: Text("Total Alkalinity")),
          ],
        ),
      ),
    );
